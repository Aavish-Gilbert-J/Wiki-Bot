...
import pyttsx3
import tkinter 
from tkinter import Toplevel,Frame,LabelFrame,Label,Text,Scrollbar,Button,Entry
from tkinter import DISABLED,BOTH,END,NORMAL
import ctypes as ct
import warnings
...
#define frames
frame_1=Frame(root, bg='grey10')
frame_2=LabelFrame(root, bg='grey10',relief='sunken',borderwidth=3)
frame_3=Frame(root,bg='grey10')
iframe=Text(frame_3,width=20,height=2,bg='grey10',fg='white',font=("Lucida",10,"bold"),padx=5,pady=5,borderwidth=3)
...
def enter1():
    ...
    label2=Label(frame_2,bg='grey10',fg='yellow',text=str.upper(wdat),font=('Algerian',16,"bold"))
...
label21=Label(frame_2,bg='grey10',fg='white',wraplength=500,text=' ')
label21.place(bordermode='inside',relx=0.1,rely=0.15,relwidth=0.81)

#frame1

labelf1=Label(frame_1,text="Enter the topic you want to search about:                                                                                                                             ",bg='grey10',fg='white',padx=5,pady=5)
labelf1.grid(row=0,column=0)

entryf1=Entry(frame_1,bg='grey98',bd='2',width=100,borderwidth=4)
entryf1.grid(row=1,column=0,padx=10)

buttonf1=Button(frame_1,text="Enter",bg='grey30',fg='black',activebackground='grey30',padx=10,borderwidth=4,width=6,command=enter1)
...
buttonf3=Button(frame_3,text="Enter",bg='grey30',fg='black',activebackground='grey30',padx=15,borderwidth=7,command=chat1)
buttonf3.place(x=510,y=555,height=37,width=114)

entryf3=Entry(frame_3,bg='grey98',bd='2',width=60,borderwidth=4)
